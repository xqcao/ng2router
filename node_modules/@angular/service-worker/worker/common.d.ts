...
export declare function cacheFromNetworkOp(worker: VersionWorker, url: string, cache: string): Operation;
...
export declare function fetchFromNetworkInstruction(worker: VersionWorker, req: Request): FetchInstruction;
